let pause = false;
// export function pauseSnowfall(boolean) {
// 	pause = boolean;
// 	isItChristmas();
// }
...
function letItSnow() {
	// pause = true;
	//  canvas init
	const canvas = document.getElementById('canvasFar');
	...
	// Sin and Cos functions will be applied to it to create vertical
	// and horizontal movements of the flakes
	//  let angle = 0;
	function update() {
		...
		for (let i = 0; i < mp; i++) {
			...
			// Every particle has its own density which can be used to make
			// the downward movement different for each flake
			...
			// Lets make it a bit more organic
			// and let flakes enter from the left and right also.
